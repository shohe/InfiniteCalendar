...
public protocol ICAllDayHeaderDelegate: AnyObject {
    func didExpand(sender: ICAllDayHeader)
}


// MARK: Foreground
public final class ICAllDayHeader: ViewHostingSupplementaryCell<ICAllDayHeaderView> {}

public struct ICAllDayHeaderView: ICComponentView {
...
// MARK: Background
public final class ICAllDayHeaderBackground: ViewHostingDecorationCell<ICAllDayHeaderBackgroundView> {
...
public struct ICAllDayHeaderBackgroundView: ICComponentView {
...
// MARK: Corner
public final class ICAllDayCorner: ViewHostingSupplementaryCell<ICAllDayCornerView> {}

public struct ICAllDayCornerView: ICComponentView {
